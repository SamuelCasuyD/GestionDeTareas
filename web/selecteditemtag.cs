...
namespace GeneXus.Programs {
   public class selecteditemtag : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public selecteditemtag( )
      {
      ...
      public selecteditemtag( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202210202185464", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("selecteditemtag.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GRID_Flexwrap", StringUtil.RTrim( subGrid_Flexwrap));
         GxWebStd.gx_hidden_field( context, "GRID_Alignitems", StringUtil.RTrim( subGrid_Alignitems));
         GxWebStd.gx_hidden_field( context, "GRID_Aligncontent", StringUtil.RTrim( subGrid_Aligncontent));
      }
      ...
      {
         return formatLink("selecteditemtag.aspx")  ;
      }
      ...
      protected void WB0I0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( GridContainer.GetWrapped() == 1 )
            {
               ...
               sStyleString = "";
               GxWebStd.gx_table_start( context, subGrid_Internalname, subGrid_Internalname, "", "K2BTools_SearchGrid", 0, "", "", 1, 2, sStyleString, "", "", 0);
            ...
            else
            {
               ...
               GridContainer.AddObjectProperty("Class", StringUtil.RTrim( "K2BTools_SearchGrid"));
               GridContainer.AddObjectProperty("Class", "K2BTools_SearchGrid");
         ...
         if ( wbEnd == 9 )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table1_25_0I2( true) ;
         }
         else
         {
            wb_table1_25_0I2( false) ;
         }
         return  ;
      }

      protected void wb_table1_25_0I2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START0I2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Selected Item Tag", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void STRUP0I0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            subGrid_Flexwrap = cgiGet( "GRID_Flexwrap");
            subGrid_Alignitems = cgiGet( "GRID_Alignitems");
            subGrid_Aligncontent = cgiGet( "GRID_Aligncontent");
      ...
      protected void wb_table1_25_0I2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_25_0I2e( true) ;
         }
         else
         {
            wb_table1_25_0I2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202210202185482", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("selecteditemtag.js", "?202210202185482", false, true);
         }
      ...
      protected void sendrow_92( )
      {
         ...
         GridRow.AddRenderProperties(GridColumn);
         /* Div Control */
         GridRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {(String)divSection1_Internalname+"_"+sGXsfl_9_idx,(short)1,(short)0,(String)"px",(short)0,(String)"px",(String)"K2BT_SelectedItemBottom",(String)"left",(String)"top",(String)"",(String)"",(String)"div"});
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
         GridRow.AddRenderProperties(GridColumn);
         /* Div Control */
      ...
      public override void initialize_properties( )
      {
         ...
         subGrid_Aligncontent = "flex-start";
         subGrid_Alignitems = "flex-start";
         subGrid_Flexwrap = "wrap";
         subGrid_Class = "K2BTools_SearchGrid";
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
         Form.Backcolor = (int)(0xFFFFFF);
         Form.Caption = "Selected Item Tag";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      private String subGrid_Alignitems ;
      private String subGrid_Aligncontent ;
