...
namespace GeneXus.Programs {
   public class k2btoolscomponentplaceholder : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202210202185182", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RenderHtmlCloseForm1P2( )
      {
         ...
         {
            context.AddJavascriptSource("k2btoolscomponentplaceholder.js", "?202210202185184", false, true);
         }
      ...
      protected void WB1P0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_6_1P2( true) ;
         }
         else
         {
            wb_table1_6_1P2( false) ;
         }
         return  ;
      }

      protected void wb_table1_6_1P2e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void wb_table1_6_1P2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table2_9_1P2( true) ;
         }
         else
         {
            wb_table2_9_1P2( false) ;
         }
         return  ;
      }

      protected void wb_table2_9_1P2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            wb_table1_6_1P2e( true) ;
         }
         else
         {
            wb_table1_6_1P2e( false) ;
         }
      }

      protected void wb_table2_9_1P2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNoresultsfoundtextblock_Internalname, "Loading...", "", "", lblNoresultsfoundtextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_NoResultsFound", 0, "", 1, 1, 0, "HLP_K2BToolsComponentPlaceHolder.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_9_1P2e( true) ;
         }
         else
         {
            wb_table2_9_1P2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202210202185192", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("k2btoolscomponentplaceholder.js", "?202210202185192", false, true);
         }
