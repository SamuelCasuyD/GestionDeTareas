...
!function($) {
    ...
    Checkbox.prototype = {
        ...
        _createButtons: function(){
			...
			if(this.$element.next('.bootstrap-checkbox').length == 0){
        ...
        clickListener: function() {
        	...
        	this.button.on('click', function(e){
				...
				if (_this.$element[0].onfocus != null){
					_this.$element[0].onfocus();
				}
				
				if (_this.$element[0].onblur != null){
					_this.$element[0].onblur();
				}
				
				_this.$element[0].click(e);
				_this.checkChecked();
        	});
