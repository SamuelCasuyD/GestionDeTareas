...
namespace GeneXus.Programs {
   public class wpagrearactividades : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public wpagrearactividades( )
      {
      ...
      public wpagrearactividades( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               GxWebStd.gx_hidden_field( context, "gxhash_vTRACTIVIDADES_ID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV18TrActividades_ID), "ZZZZZZZZZZZZ9"), context));
            }
            if ( context.isSpaRequest( ) )
            {
               enableJsOutput();
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202210211745042", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wpagrearactividades.aspx") + "?" + UrlEncode("" +AV18TrActividades_ID)+"\">") ;
      ...
      {
         return formatLink("wpagrearactividades.aspx") + "?" + UrlEncode("" +AV18TrActividades_ID) ;
      }

      public override String GetPgmname( )
      {
         return "WpAgrearActividades" ;
      }
      ...
      protected void WB2E0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitle_Internalname, "Nueva", "", "", lblTitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_Title", 0, "", 1, 1, 0, "HLP_WpAgrearActividades.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Control Group */
            GxWebStd.gx_group_start( context, grpGroup_Internalname, "Ingresar datos solicitados", 1, 0, "px", 0, "px", "Group_Tabular", "", "HLP_WpAgrearActividades.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTrlistaactividad_nombre_var_lefttext_Internalname, "Nombre : ", "", "", lblTrlistaactividad_nombre_var_lefttext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SideLabel", 0, "", 1, 1, 0, "HLP_WpAgrearActividades.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 39,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavTrlistaactividad_nombre_Internalname, StringUtil.RTrim( AV13TrListaActividad_Nombre), StringUtil.RTrim( context.localUtil.Format( AV13TrListaActividad_Nombre, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,39);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTrlistaactividad_nombre_Jsonclick, 0, "Attribute_Trn", "", "", "", "", 1, edtavTrlistaactividad_nombre_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_WpAgrearActividades.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTrlistaactividad_descripcion_var_lefttext_Internalname, "Descripción : ", "", "", lblTrlistaactividad_descripcion_var_lefttext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SideLabel", 0, "", 1, 1, 0, "HLP_WpAgrearActividades.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Multiple line edit */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTrlistaactividad_fechainicio_var_lefttext_Internalname, "Fecha de inicio : ", "", "", lblTrlistaactividad_fechainicio_var_lefttext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SideLabel", 0, "", 1, 1, 0, "HLP_WpAgrearActividades.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            ...
            GxWebStd.gx_single_line_edit( context, edtavTrlistaactividad_fechainicio_Internalname, context.localUtil.Format(AV15TrListaActividad_FechaInicio, "99/99/9999"), context.localUtil.Format( AV15TrListaActividad_FechaInicio, "99/99/9999"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'DMY',0,24,'spa',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 10,'DMY',0,24,'spa',false,0);"+";gx.evt.onblur(this,53);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTrlistaactividad_fechainicio_Jsonclick, 0, "Attribute_TrnDate", "", "", "", "", 1, edtavTrlistaactividad_fechainicio_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_WpAgrearActividades.htm");
            GxWebStd.gx_bitmap( context, edtavTrlistaactividad_fechainicio_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavTrlistaactividad_fechainicio_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_WpAgrearActividades.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTrlistaactividad_fechafin_var_lefttext_Internalname, "Fecha de fin : ", "", "", lblTrlistaactividad_fechafin_var_lefttext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SideLabel", 0, "", 1, 1, 0, "HLP_WpAgrearActividades.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            ...
            GxWebStd.gx_single_line_edit( context, edtavTrlistaactividad_fechafin_Internalname, context.localUtil.Format(AV16TrListaActividad_FechaFin, "99/99/9999"), context.localUtil.Format( AV16TrListaActividad_FechaFin, "99/99/9999"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'DMY',0,24,'spa',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 10,'DMY',0,24,'spa',false,0);"+";gx.evt.onblur(this,60);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTrlistaactividad_fechafin_Jsonclick, 0, "Attribute_TrnDate", "", "", "", "", 1, edtavTrlistaactividad_fechafin_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_WpAgrearActividades.htm");
            GxWebStd.gx_bitmap( context, edtavTrlistaactividad_fechafin_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavTrlistaactividad_fechafin_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_WpAgrearActividades.htm");
            context.WriteHtmlTextNl( "</div>") ;
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTrlistaactividad_estado_var_lefttext_Internalname, "Estado : ", "", "", lblTrlistaactividad_estado_var_lefttext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SideLabel", 0, "", 1, 1, 0, "HLP_WpAgrearActividades.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 67,'',false,'',0)\"";
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavTrlistaactividad_estado, cmbavTrlistaactividad_estado_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV17TrListaActividad_Estado), 4, 0)), 1, cmbavTrlistaactividad_estado_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", 1, cmbavTrlistaactividad_estado.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute_Trn", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,67);\"", "", true, "HLP_WpAgrearActividades.htm");
      ...
      protected void STRUP2E0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( StringUtil.StrCmp(cgiGet( edtavTrlistaactividad_id_Internalname), "") == 0 )
            {
               AV12TrListaActividad_ID = (Guid)(Guid.Empty);
               AssignAttri("", false, "AV12TrListaActividad_ID", AV12TrListaActividad_ID.ToString());
            }
            else
            {
               try
               {
                  AV12TrListaActividad_ID = (Guid)(StringUtil.StrToGuid( cgiGet( edtavTrlistaactividad_id_Internalname)));
                  AssignAttri("", false, "AV12TrListaActividad_ID", AV12TrListaActividad_ID.ToString());
               }
               catch ( Exception e )
               {
                  GX_msglist.addItem(context.GetMessage( "GXM_invalidguid", ""), 1, "vTRLISTAACTIVIDAD_ID");
                  GX_FocusControl = edtavTrlistaactividad_id_Internalname;
                  AssignAttri("", false, "GX_FocusControl", GX_FocusControl);
                  wbErr = true;
               }
            }
            AV13TrListaActividad_Nombre = cgiGet( edtavTrlistaactividad_nombre_Internalname);
            AssignAttri("", false, "AV13TrListaActividad_Nombre", AV13TrListaActividad_Nombre);
            AV14TrListaActividad_Descripcion = cgiGet( edtavTrlistaactividad_descripcion_Internalname);
            AssignAttri("", false, "AV14TrListaActividad_Descripcion", AV14TrListaActividad_Descripcion);
            if ( context.localUtil.VCDate( cgiGet( edtavTrlistaactividad_fechainicio_Internalname), 2) == 0 )
            {
               ...
               AssignAttri("", false, "AV15TrListaActividad_FechaInicio", context.localUtil.Format(AV15TrListaActividad_FechaInicio, "99/99/9999"));
            }
            else
            {
               AV15TrListaActividad_FechaInicio = context.localUtil.CToD( cgiGet( edtavTrlistaactividad_fechainicio_Internalname), 2);
               AssignAttri("", false, "AV15TrListaActividad_FechaInicio", context.localUtil.Format(AV15TrListaActividad_FechaInicio, "99/99/9999"));
            }
            if ( context.localUtil.VCDate( cgiGet( edtavTrlistaactividad_fechafin_Internalname), 2) == 0 )
            {
               ...
               AssignAttri("", false, "AV16TrListaActividad_FechaFin", context.localUtil.Format(AV16TrListaActividad_FechaFin, "99/99/9999"));
            }
            else
            {
               AV16TrListaActividad_FechaFin = context.localUtil.CToD( cgiGet( edtavTrlistaactividad_fechafin_Internalname), 2);
               AssignAttri("", false, "AV16TrListaActividad_FechaFin", context.localUtil.Format(AV16TrListaActividad_FechaFin, "99/99/9999"));
            }
            cmbavTrlistaactividad_estado.CurrentValue = cgiGet( cmbavTrlistaactividad_estado_Internalname);
            AV17TrListaActividad_Estado = (short)(NumberUtil.Val( cgiGet( cmbavTrlistaactividad_estado_Internalname), "."));
            AssignAttri("", false, "AV17TrListaActividad_Estado", StringUtil.LTrimStr( (decimal)(AV17TrListaActividad_Estado), 4, 0));
            AV19ConfirmMessage = cgiGet( edtavConfirmmessage_Internalname);
            AssignAttri("", false, "AV19ConfirmMessage", AV19ConfirmMessage);
      ...
      protected void E132E2( )
      {
         ...
         AV19ConfirmMessage = "¿Está seguro?";
         AssignAttri("", false, "AV19ConfirmMessage", AV19ConfirmMessage);
         /* Execute user subroutine: 'U_CONFIRMATIONREQUIRED(AGREGARACTIVIDAD)' */
         S142 ();
         if (returnInSub) return;
         if ( AV20ConfirmationRequired )
         {
            AV21ConfirmationSubId = "'U_AgregarActividad'";
            AssignAttri("", false, "AV21ConfirmationSubId", AV21ConfirmationSubId);
      ...
      protected void S152( )
      {
         ...
         AV22GestionActividades_SDT.gxTpr_Tractividades_id = AV18TrActividades_ID;
         AV22GestionActividades_SDT.gxTpr_Trlistaactividad_nombre = AV13TrListaActividad_Nombre;
         AV22GestionActividades_SDT.gxTpr_Trlistaactividad_descripcion = AV14TrListaActividad_Descripcion;
         AV22GestionActividades_SDT.gxTpr_Trlistaactividad_fechainicio = AV15TrListaActividad_FechaInicio;
         AV22GestionActividades_SDT.gxTpr_Trlistaactividad_fechafin = AV16TrListaActividad_FechaFin;
         AV22GestionActividades_SDT.gxTpr_Trlistaactividad_estado = AV17TrListaActividad_Estado;
         new prgestionaractividades(context ).execute(  AV22GestionActividades_SDT,  "AIN") ;
      ...
      protected void E142E2( )
      {
         ...
         tblTableconditionalconfirm_Visible = 0;
         AssignProp("", false, tblTableconditionalconfirm_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(tblTableconditionalconfirm_Visible), 5, 0), true);
         if ( StringUtil.StrCmp(AV21ConfirmationSubId, "'U_AgregarActividad'") == 0 )
         {
            /* Execute user subroutine: 'U_AGREGARACTIVIDAD' */
            S152 ();
            if (returnInSub) return;
      ...
      protected void wb_table5_92_2E2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttI_buttonconfirmyes_Internalname, "", "Aceptar", bttI_buttonconfirmyes_Jsonclick, 5, "Aceptar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'CONFIRMYES\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WpAgrearActividades.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 97,'',false,'',0)\"";
            ClassString = "Button_Standard";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttI_buttonconfirmno_Internalname, "", "Cancelar", bttI_buttonconfirmno_Jsonclick, 7, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e162e1_client"+"'", TempTags, "", 2, "HLP_WpAgrearActividades.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
      ...
      protected void wb_table1_73_2E2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttAgregaractividad_Internalname, "", "Agregar Actividad", bttAgregaractividad_Jsonclick, 5, "", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'E_AGREGARACTIVIDAD\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WpAgrearActividades.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202210211745097", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wpagrearactividades.js", "?202210211745097", false, true);
         context.AddJavascriptSource("K2BControlBeautify/montrezorro-bootstrap-checkbox/js/bootstrap-checkbox.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/silviomoreto-bootstrap-select/dist/js/bootstrap-select.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV18TrActividades_ID',fld:'vTRACTIVIDADES_ID',pic:'ZZZZZZZZZZZZ9',hsh:true}]");
         ...
         setEventMetadata("'E_AGREGARACTIVIDAD'","{handler:'E132E2',iparms:[{av:'AV20ConfirmationRequired',fld:'vCONFIRMATIONREQUIRED',pic:''},{av:'AV18TrActividades_ID',fld:'vTRACTIVIDADES_ID',pic:'ZZZZZZZZZZZZ9',hsh:true},{av:'AV22GestionActividades_SDT',fld:'vGESTIONACTIVIDADES_SDT',pic:''},{av:'AV13TrListaActividad_Nombre',fld:'vTRLISTAACTIVIDAD_NOMBRE',pic:''},{av:'AV14TrListaActividad_Descripcion',fld:'vTRLISTAACTIVIDAD_DESCRIPCION',pic:''},{av:'AV15TrListaActividad_FechaInicio',fld:'vTRLISTAACTIVIDAD_FECHAINICIO',pic:''},{av:'AV16TrListaActividad_FechaFin',fld:'vTRLISTAACTIVIDAD_FECHAFIN',pic:''},{av:'cmbavTrlistaactividad_estado'},{av:'AV17TrListaActividad_Estado',fld:'vTRLISTAACTIVIDAD_ESTADO',pic:'ZZZ9'}]");
         setEventMetadata("'E_AGREGARACTIVIDAD'",",oparms:[{av:'AV19ConfirmMessage',fld:'vCONFIRMMESSAGE',pic:''},{av:'AV21ConfirmationSubId',fld:'vCONFIRMATIONSUBID',pic:''},{av:'tblTableconditionalconfirm_Visible',ctrl:'TABLECONDITIONALCONFIRM',prop:'Visible'},{av:'AV20ConfirmationRequired',fld:'vCONFIRMATIONREQUIRED',pic:''},{av:'AV22GestionActividades_SDT',fld:'vGESTIONACTIVIDADES_SDT',pic:''}]}");
         setEventMetadata("'CONFIRMNO'","{handler:'E162E1',iparms:[]");
         ...
         setEventMetadata("'CONFIRMYES'","{handler:'E142E2',iparms:[{av:'AV21ConfirmationSubId',fld:'vCONFIRMATIONSUBID',pic:''},{av:'AV18TrActividades_ID',fld:'vTRACTIVIDADES_ID',pic:'ZZZZZZZZZZZZ9',hsh:true},{av:'AV22GestionActividades_SDT',fld:'vGESTIONACTIVIDADES_SDT',pic:''},{av:'AV13TrListaActividad_Nombre',fld:'vTRLISTAACTIVIDAD_NOMBRE',pic:''},{av:'AV14TrListaActividad_Descripcion',fld:'vTRLISTAACTIVIDAD_DESCRIPCION',pic:''},{av:'AV15TrListaActividad_FechaInicio',fld:'vTRLISTAACTIVIDAD_FECHAINICIO',pic:''},{av:'AV16TrListaActividad_FechaFin',fld:'vTRLISTAACTIVIDAD_FECHAFIN',pic:''},{av:'cmbavTrlistaactividad_estado'},{av:'AV17TrListaActividad_Estado',fld:'vTRLISTAACTIVIDAD_ESTADO',pic:'ZZZ9'}]");
