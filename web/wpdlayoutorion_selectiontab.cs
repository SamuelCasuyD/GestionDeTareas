...
namespace GeneXus.Programs {
   public class wpdlayoutorion_selectiontab : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public wpdlayoutorion_selectiontab( )
      {
      ...
      public wpdlayoutorion_selectiontab( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               nRC_GXsfl_123 = (int)(NumberUtil.Val( GetNextPar( ), "."));
               nGXsfl_123_idx = (int)(NumberUtil.Val( GetNextPar( ), "."));
               sGXsfl_123_idx = GetNextPar( );
               setAjaxCallMode();
               if ( ! IsValidAjaxCall( true) )
               {
                  GxWebError = 1;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202210211744528", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wpdlayoutorion_selectiontab.aspx") +"\">") ;
      ...
      {
         return formatLink("wpdlayoutorion_selectiontab.aspx")  ;
      }

      public override String GetPgmname( )
      {
         return "WPDLayoutOrion_SelectionTab" ;
      }

      public override String GetPgmdesc( )
      {
         return "Grid with selected items in tab" ;
      }
      ...
      protected void WB170( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitle_Internalname, "Title placeholder", "", "", lblTitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_Title", 0, "", 1, 1, 0, "HLP_WPDLayoutOrion_SelectionTab.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLeftactions_Internalname, "LeftActions", "", "", lblLeftactions_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_WPDLayoutOrion_SelectionTab.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTopactions_Internalname, "TopActions", "", "", lblTopactions_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_WPDLayoutOrion_SelectionTab.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table1_35_172( true) ;
         }
         else
         {
            wb_table1_35_172( false) ;
         }
         return  ;
      }

      protected void wb_table1_35_172e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 64,'',false,'" + sGXsfl_123_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavK2btoolsgenericsearchfield_Internalname, StringUtil.RTrim( AV5K2BToolsGenericSearchField), StringUtil.RTrim( context.localUtil.Format( AV5K2BToolsGenericSearchField, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,64);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Buscar...", edtavK2btoolsgenericsearchfield_Jsonclick, 0, "K2BTools_SearchCriteria", "", "", "", "", 1, edtavK2btoolsgenericsearchfield_Enabled, 0, "text", "", 40, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_WPDLayoutOrion_SelectionTab.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_bitmap( context, imgFiltertoggle_combined_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "", 0, 0, 0, "px", 0, "px", 0, 0, 5, imgFiltertoggle_combined_Jsonclick, "'"+""+"'"+",false,"+"'"+"EFILTERTOGGLE_COMBINED.CLICK."+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_WPDLayoutOrion_SelectionTab.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblFiltersummary_combined_Internalname, "Filter Summary", "", "", lblFiltersummary_combined_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_FilterSummary", 0, "", 1, 1, 0, "HLP_WPDLayoutOrion_SelectionTab.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            wb_table2_71_172( true) ;
         }
         else
         {
            wb_table2_71_172( false) ;
         }
         return  ;
      }

      protected void wb_table2_71_172e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblFiltersummary_onlydetailed_Internalname, "Filter Summary", "", "", lblFiltersummary_onlydetailed_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_FilterSummary", 0, "", 1, 1, 0, "HLP_WPDLayoutOrion_SelectionTab.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            wb_table3_87_172( true) ;
         }
         else
         {
            wb_table3_87_172( false) ;
         }
         return  ;
      }

      protected void wb_table3_87_172e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 98,'',false,'" + sGXsfl_123_idx + "',0)\"";
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGridactionsleft_Internalname, "GridActionsLeft", "", "", lblGridactionsleft_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_WPDLayoutOrion_SelectionTab.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4", "left", "top", "", "", "div");
            wb_table4_109_172( true) ;
         }
         else
         {
            wb_table4_109_172( false) ;
         }
         return  ;
      }

      protected void wb_table4_109_172e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSelectionsummaryallitemstab_title_Internalname, "All", "", "", lblSelectionsummaryallitemstab_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_WPDLayoutOrion_SelectionTab.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
            context.WriteHtmlText( "SelectionSummaryAllItemsTab") ;
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</div>") ;
            ...
            {
               context.WriteHtmlText( "<div id=\""+"GridcontentContainer"+"DivS\" data-gxgridid=\"123\">") ;
               sStyleString = "";
         ...
         if ( wbEnd == 123 )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSelectionsummaryselecteditemstab_title_Internalname, "Selected", "", "", lblSelectionsummaryselecteditemstab_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_WPDLayoutOrion_SelectionTab.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
            context.WriteHtmlText( "SelectionSummarySelectedItemsTab") ;
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</div>") ;
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSelectionsummary_Internalname, "Selection Summary", "", "", lblSelectionsummary_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_WPDLayoutOrion_SelectionTab.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSelectionsummarynoitemstextblock_Internalname, "Text Block", "", "", lblSelectionsummarynoitemstextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_NoResultsFound", 0, "", 1, 1, 0, "HLP_WPDLayoutOrion_SelectionTab.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            wb_table5_144_172( true) ;
         }
         else
         {
            wb_table5_144_172( false) ;
         }
         return  ;
      }

      protected void wb_table5_144_172e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGridrecordcount_Internalname, "Record count", "", "", lblGridrecordcount_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_WPDLayoutOrion_SelectionTab.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4", "left", "top", "", "", "div");
            wb_table6_152_172( true) ;
         }
         else
         {
            wb_table6_152_172( false) ;
         }
         return  ;
      }

      protected void wb_table6_152_172e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4", "left", "top", "", "", "div");
            wb_table7_157_172( true) ;
         }
         else
         {
            wb_table7_157_172( false) ;
         }
         return  ;
      }

      protected void wb_table7_157_172e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblBottomactions_Internalname, "BottomActions", "", "", lblBottomactions_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_WPDLayoutOrion_SelectionTab.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblHiddenitems_Internalname, "HiddenItems", "", "", lblHiddenitems_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_WPDLayoutOrion_SelectionTab.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblConditionalconfirm_Internalname, "ConditionalConfirm", "", "", lblConditionalconfirm_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_WPDLayoutOrion_SelectionTab.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
      ...
      protected void START172( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Grid with selected items in tab", 0) ;
         }
         context.wjLoc = "";
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           {
                              nGXsfl_123_idx = (int)(NumberUtil.Val( sEvtType, "."));
      ...
      protected void gxnrGridcontent_newrow( )
      {
         ...
         {
            sendrow_1232( ) ;
            nGXsfl_123_idx = ((subGridcontent_Islastpage==1)&&(nGXsfl_123_idx+1>subGridcontent_fnc_Recordsperpage( )) ? 1 : nGXsfl_123_idx+1);
            sGXsfl_123_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_123_idx), 4, 0), 4, "0");
            SubsflControlProps_1232( ) ;
         }
      ...
      protected void STRUP170( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            nRC_GXsfl_123 = (int)(context.localUtil.CToN( cgiGet( "nRC_GXsfl_123"), ".", ","));
      ...
      protected void wb_table7_157_172( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock1_Internalname, "Paging", "", "", lblTextblock1_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_WPDLayoutOrion_SelectionTab.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table7_157_172e( true) ;
         }
         else
         {
            wb_table7_157_172e( false) ;
         }
      }

      protected void wb_table6_152_172( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblOrderby_Internalname, "OrderedBy", "", "", lblOrderby_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_WPDLayoutOrion_SelectionTab.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table6_152_172e( true) ;
         }
         else
         {
            wb_table6_152_172e( false) ;
         }
      }

      protected void wb_table5_144_172( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock2_Internalname, "Summary", "", "", lblTextblock2_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_WPDLayoutOrion_SelectionTab.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table5_144_172e( true) ;
         }
         else
         {
            wb_table5_144_172e( false) ;
         }
      }

      protected void wb_table4_109_172( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGridactionsright_Internalname, "GridActionsRight", "", "", lblGridactionsright_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_WPDLayoutOrion_SelectionTab.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table4_109_172e( true) ;
         }
         else
         {
            wb_table4_109_172e( false) ;
         }
      }

      protected void wb_table3_87_172( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock4_Internalname, "Filters", "", "", lblTextblock4_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_WPDLayoutOrion_SelectionTab.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_87_172e( true) ;
         }
         else
         {
            wb_table3_87_172e( false) ;
         }
      }

      protected void wb_table2_71_172( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblFilters_Internalname, "Filters", "", "", lblFilters_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_WPDLayoutOrion_SelectionTab.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_71_172e( true) ;
         }
         else
         {
            wb_table2_71_172e( false) ;
         }
      }

      protected void wb_table1_35_172( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGridsettingscontainer_Internalname, "GridSettingsContainer", "", "", lblGridsettingscontainer_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_WPDLayoutOrion_SelectionTab.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblRuntimecolumnmanagement_Internalname, "RuntimeColumnManagement", "", "", lblRuntimecolumnmanagement_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_WPDLayoutOrion_SelectionTab.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Div Control */
            ...
            GxWebStd.gx_bitmap( context, imgDownloadsactiontoggle_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgDownloadsactiontoggle_Jsonclick, "'"+""+"'"+",false,"+"'"+"e17171_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_WPDLayoutOrion_SelectionTab.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblDownloadsactionssection_Internalname, "DownloadsActionsSection", "", "", lblDownloadsactionssection_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_WPDLayoutOrion_SelectionTab.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblRightactions_Internalname, "RightActions", "", "", lblRightactions_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_WPDLayoutOrion_SelectionTab.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_35_172e( true) ;
         }
         else
         {
            wb_table1_35_172e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202210211744719", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wpdlayoutorion_selectiontab.js", "?202210211744719", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         lblSelectionsummaryallitemstab_title_Internalname = "SELECTIONSUMMARYALLITEMSTAB_TITLE";
         divTabpage1table_Internalname = "TABPAGE1TABLE";
         lblSelectionsummaryselecteditemstab_title_Internalname = "SELECTIONSUMMARYSELECTEDITEMSTAB_TITLE";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Grid with selected items in tab";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("FILTERTOGGLE_COMBINED.CLICK","{handler:'E11172',iparms:[{av:'divFiltercollapsiblesection_combined_Visible',ctrl:'FILTERCOLLAPSIBLESECTION_COMBINED',prop:'Visible'}]");
         ...
         setEventMetadata("FILTERCLOSE_COMBINED.CLICK","{handler:'E12172',iparms:[]");
         ...
         setEventMetadata("FILTERTOGGLE_ONLYDETAILED.CLICK","{handler:'E13172',iparms:[{av:'divFiltercollapsiblesection_onlydetailed_Visible',ctrl:'FILTERCOLLAPSIBLESECTION_ONLYDETAILED',prop:'Visible'}]");
         ...
         setEventMetadata("FILTERCLOSE_ONLYDETAILED.CLICK","{handler:'E14172',iparms:[]");
         ...
         setEventMetadata("DOWNLOADSACTIONTOGGLE.CLICK","{handler:'E17171',iparms:[{av:'divDownloadactionstable_Visible',ctrl:'DOWNLOADACTIONSTABLE',prop:'Visible'}]");
      ...
      public override void initialize( )
      {
         ...
         lblSelectionsummaryallitemstab_title_Jsonclick = "";
         GridcontentContainer = new GXWebGrid( context);
         sStyleString = "";
         subGridcontent_Linesclass = "";
         lblSelectionsummaryselecteditemstab_title_Jsonclick = "";
      ...
      private String lblSelectionsummaryallitemstab_title_Internalname ;
      private String lblSelectionsummaryallitemstab_title_Jsonclick ;
      ...
      private String lblSelectionsummaryselecteditemstab_title_Internalname ;
      private String lblSelectionsummaryselecteditemstab_title_Jsonclick ;
