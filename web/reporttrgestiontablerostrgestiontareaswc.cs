...
namespace GeneXus.Programs {
   public class reporttrgestiontablerostrgestiontareaswc : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public reporttrgestiontablerostrgestiontareaswc( )
      {
      ...
      public reporttrgestiontablerostrgestiontareaswc( IGxContext context )
      {
      ...
      public void executeSubmit( Guid aP0_TrGestionTareas_IDTablero ,
                                 short aP1_OrderedBy )
      {
         reporttrgestiontablerostrgestiontareaswc objreporttrgestiontablerostrgestiontareaswc;
         objreporttrgestiontablerostrgestiontareaswc = new reporttrgestiontablerostrgestiontareaswc();
         objreporttrgestiontablerostrgestiontareaswc.AV9TrGestionTareas_IDTablero = aP0_TrGestionTareas_IDTablero;
         objreporttrgestiontablerostrgestiontareaswc.AV11OrderedBy = aP1_OrderedBy;
         objreporttrgestiontablerostrgestiontareaswc.context.SetSubmitInitialConfig(context);
         objreporttrgestiontablerostrgestiontareaswc.initialize();
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objreporttrgestiontablerostrgestiontareaswc);
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((reporttrgestiontablerostrgestiontareaswc)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         try
         {
            ...
            if ( ! new k2bisauthorizedactivityname(context).executeUdp(  "TrGestionTareas",  "TrGestionTareas",  "List",  "",  AV18Pgmname) )
            {
               H2K0( false, 30) ;
            ...
            else
            {
               ...
               getPrinter().GxDrawText("Tr Gestion Tareas", 212, Gx_line+-1, 585, Gx_line+41, 0+256, 0, 0, 0) ;
               Gx_OldLine = Gx_line;
               ...
               getPrinter().GxDrawText("Gestion Tareas_ID", 10, Gx_line+8, 135, Gx_line+23, 0+256, 0, 0, 0) ;
               Gx_OldLine = Gx_line;
               Gx_line = (int)(Gx_line+30);
               GxHdr3 = true;
               ...
               {
                  A11TrGestionTareas_IDTablero = (Guid)((Guid)(P002K2_A11TrGestionTareas_IDTablero[0]));
                  A13TrGestionTareas_Nombre = P002K2_A13TrGestionTareas_Nombre[0];
                  n13TrGestionTareas_Nombre = P002K2_n13TrGestionTareas_Nombre[0];
                  A12TrGestionTareas_ID = P002K2_A12TrGestionTareas_ID[0];
                  H2K0( false, 30) ;
                  getPrinter().GxAttris("Courier New", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
                  getPrinter().GxDrawText(StringUtil.LTrim( context.localUtil.Format( (decimal)(A12TrGestionTareas_ID), "ZZZZZZZZZZZZ9")), 10, Gx_line+7, 106, Gx_line+23, 2, 0, 0, 0) ;
                  Gx_OldLine = Gx_line;
                  Gx_line = (int)(Gx_line+30);
      ...
      public override void initialize( )
      {
         ...
         P002K2_A11TrGestionTareas_IDTablero = new Guid[] {Guid.Empty} ;
         P002K2_A13TrGestionTareas_Nombre = new String[] {""} ;
         P002K2_n13TrGestionTareas_Nombre = new bool[] {false} ;
         P002K2_A12TrGestionTareas_ID = new long[1] ;
         A13TrGestionTareas_Nombre = "";
         Gx_date = DateTime.MinValue;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.reporttrgestiontablerostrgestiontareaswc__default(),
            new Object[][] {
                new Object[] {
               P002K2_A11TrGestionTareas_IDTablero, P002K2_A13TrGestionTareas_Nombre, P002K2_n13TrGestionTareas_Nombre, P002K2_A12TrGestionTareas_ID
               }
            }
         );
         AV18Pgmname = "ReportTrGestionTablerosTrGestionTareasWC";
      ...
      private Guid[] P002K2_A11TrGestionTareas_IDTablero ;
      private String[] P002K2_A13TrGestionTareas_Nombre ;
      private bool[] P002K2_n13TrGestionTareas_Nombre ;
      private long[] P002K2_A12TrGestionTareas_ID ;
      private SdtK2BContext AV8Context ;
   }

   public class reporttrgestiontablerostrgestiontareaswc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             Guid A11TrGestionTareas_IDTablero )
      {
         ...
         scmdbuf = "SELECT [TrGestionTareas_IDTablero], [TrGestionTareas_Nombre], [TrGestionTareas_ID] FROM TABLERO.[TrGestionTareas]";
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P002K2(context, (short)dynConstraints[0] , (Guid)dynConstraints[1] , (Guid)dynConstraints[2] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P002K2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP002K2,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
