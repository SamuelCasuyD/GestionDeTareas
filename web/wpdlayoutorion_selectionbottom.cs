...
namespace GeneXus.Programs {
   public class wpdlayoutorion_selectionbottom : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public wpdlayoutorion_selectionbottom( )
      {
      ...
      public wpdlayoutorion_selectionbottom( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               nRC_GXsfl_115 = (int)(NumberUtil.Val( GetNextPar( ), "."));
               nGXsfl_115_idx = (int)(NumberUtil.Val( GetNextPar( ), "."));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wpdlayoutorion_selectionbottom.aspx") +"\">") ;
      ...
      {
         return formatLink("wpdlayoutorion_selectionbottom.aspx")  ;
      }

      public override String GetPgmname( )
      {
         return "WPDLayoutOrion_SelectionBottom" ;
      }

      public override String GetPgmdesc( )
      {
         return "Grid with selection below" ;
      }
      ...
      protected void WB160( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitle_Internalname, "Title placeholder", "", "", lblTitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_Title", 0, "", 1, 1, 0, "HLP_WPDLayoutOrion_SelectionBottom.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLeftactions_Internalname, "LeftActions", "", "", lblLeftactions_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_WPDLayoutOrion_SelectionBottom.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTopactions_Internalname, "TopActions", "", "", lblTopactions_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_WPDLayoutOrion_SelectionBottom.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table1_35_162( true) ;
         }
         else
         {
            wb_table1_35_162( false) ;
         }
         return  ;
      }

      protected void wb_table1_35_162e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_bitmap( context, imgFiltertoggle_combined_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "", 0, 0, 0, "px", 0, "px", 0, 0, 5, imgFiltertoggle_combined_Jsonclick, "'"+""+"'"+",false,"+"'"+"EFILTERTOGGLE_COMBINED.CLICK."+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_WPDLayoutOrion_SelectionBottom.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblFiltersummary_combined_Internalname, "Filter Summary", "", "", lblFiltersummary_combined_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_FilterSummary", 0, "", 1, 1, 0, "HLP_WPDLayoutOrion_SelectionBottom.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            wb_table2_71_162( true) ;
         }
         else
         {
            wb_table2_71_162( false) ;
         }
         return  ;
      }

      protected void wb_table2_71_162e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblFiltersummary_onlydetailed_Internalname, "Filter Summary", "", "", lblFiltersummary_onlydetailed_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_FilterSummary", 0, "", 1, 1, 0, "HLP_WPDLayoutOrion_SelectionBottom.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            wb_table3_87_162( true) ;
         }
         else
         {
            wb_table3_87_162( false) ;
         }
         return  ;
      }

      protected void wb_table3_87_162e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 98,'',false,'" + sGXsfl_115_idx + "',0)\"";
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGridactionsleft_Internalname, "GridActionsLeft", "", "", lblGridactionsleft_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_WPDLayoutOrion_SelectionBottom.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4", "left", "top", "", "", "div");
            wb_table4_109_162( true) ;
         }
         else
         {
            wb_table4_109_162( false) ;
         }
         return  ;
      }

      protected void wb_table4_109_162e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            {
               context.WriteHtmlText( "<div id=\""+"GridcontentContainer"+"DivS\" data-gxgridid=\"115\">") ;
               sStyleString = "";
         ...
         if ( wbEnd == 115 )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            wb_table5_119_162( true) ;
         }
         else
         {
            wb_table5_119_162( false) ;
         }
         return  ;
      }

      protected void wb_table5_119_162e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGridrecordcount_Internalname, "Record count", "", "", lblGridrecordcount_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_WPDLayoutOrion_SelectionBottom.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4", "left", "top", "", "", "div");
            wb_table6_127_162( true) ;
         }
         else
         {
            wb_table6_127_162( false) ;
         }
         return  ;
      }

      protected void wb_table6_127_162e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4", "left", "top", "", "", "div");
            wb_table7_132_162( true) ;
         }
         else
         {
            wb_table7_132_162( false) ;
         }
         return  ;
      }

      protected void wb_table7_132_162e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divTable4_Internalname, 1, 0, "px", 0, "px", "K2BT_SelectedItemsBottom", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSelectionsummary_Internalname, "Selection Summary", "", "", lblSelectionsummary_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_WPDLayoutOrion_SelectionBottom.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSelectionsummarynoitemstextblock_Internalname, "Text Block", "", "", lblSelectionsummarynoitemstextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_NoResultsFound", 0, "", 1, 1, 0, "HLP_WPDLayoutOrion_SelectionBottom.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblBottomactions_Internalname, "BottomActions", "", "", lblBottomactions_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_WPDLayoutOrion_SelectionBottom.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblHiddenitems_Internalname, "HiddenItems", "", "", lblHiddenitems_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_WPDLayoutOrion_SelectionBottom.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblConditionalconfirm_Internalname, "ConditionalConfirm", "", "", lblConditionalconfirm_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_WPDLayoutOrion_SelectionBottom.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
      ...
      protected void START162( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Grid with selection below", 0) ;
         }
         context.wjLoc = "";
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           {
                              nGXsfl_115_idx = (int)(NumberUtil.Val( sEvtType, "."));
      ...
      protected void gxnrGridcontent_newrow( )
      {
         ...
         {
            sendrow_1152( ) ;
            nGXsfl_115_idx = ((subGridcontent_Islastpage==1)&&(nGXsfl_115_idx+1>subGridcontent_fnc_Recordsperpage( )) ? 1 : nGXsfl_115_idx+1);
            sGXsfl_115_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_115_idx), 4, 0), 4, "0");
            SubsflControlProps_1152( ) ;
         }
      ...
      protected void STRUP160( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            nRC_GXsfl_115 = (int)(context.localUtil.CToN( cgiGet( "nRC_GXsfl_115"), ".", ","));
      ...
      protected void wb_table7_132_162( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock1_Internalname, "Paging", "", "", lblTextblock1_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_WPDLayoutOrion_SelectionBottom.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table7_132_162e( true) ;
         }
         else
         {
            wb_table7_132_162e( false) ;
         }
      }

      protected void wb_table6_127_162( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblOrderby_Internalname, "OrderedBy", "", "", lblOrderby_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_WPDLayoutOrion_SelectionBottom.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table6_127_162e( true) ;
         }
         else
         {
            wb_table6_127_162e( false) ;
         }
      }

      protected void wb_table5_119_162( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock2_Internalname, "Summary", "", "", lblTextblock2_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_WPDLayoutOrion_SelectionBottom.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table5_119_162e( true) ;
         }
         else
         {
            wb_table5_119_162e( false) ;
         }
      }

      protected void wb_table4_109_162( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGridactionsright_Internalname, "GridActionsRight", "", "", lblGridactionsright_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_WPDLayoutOrion_SelectionBottom.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table4_109_162e( true) ;
         }
         else
         {
            wb_table4_109_162e( false) ;
         }
      }

      protected void wb_table3_87_162( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock4_Internalname, "Filters", "", "", lblTextblock4_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_WPDLayoutOrion_SelectionBottom.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_87_162e( true) ;
         }
         else
         {
            wb_table3_87_162e( false) ;
         }
      }

      protected void wb_table2_71_162( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblFilters_Internalname, "Filters", "", "", lblFilters_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_WPDLayoutOrion_SelectionBottom.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_71_162e( true) ;
         }
         else
         {
            wb_table2_71_162e( false) ;
         }
      }

      protected void wb_table1_35_162( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGridsettingscontainer_Internalname, "GridSettingsContainer", "", "", lblGridsettingscontainer_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_WPDLayoutOrion_SelectionBottom.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblRuntimecolumnmanagement_Internalname, "RuntimeColumnManagement", "", "", lblRuntimecolumnmanagement_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_WPDLayoutOrion_SelectionBottom.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Div Control */
            ...
            GxWebStd.gx_bitmap( context, imgDownloadsactiontoggle_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgDownloadsactiontoggle_Jsonclick, "'"+""+"'"+",false,"+"'"+"e17161_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_WPDLayoutOrion_SelectionBottom.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblDownloadsactionssection_Internalname, "DownloadsActionsSection", "", "", lblDownloadsactionssection_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_WPDLayoutOrion_SelectionBottom.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblRightactions_Internalname, "RightActions", "", "", lblRightactions_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_WPDLayoutOrion_SelectionBottom.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_35_162e( true) ;
         }
         else
         {
            wb_table1_35_162e( false) ;
         }
      }
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Grid with selection below";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("FILTERTOGGLE_COMBINED.CLICK","{handler:'E11162',iparms:[{av:'divFiltercollapsiblesection_combined_Visible',ctrl:'FILTERCOLLAPSIBLESECTION_COMBINED',prop:'Visible'}]");
         ...
         setEventMetadata("FILTERCLOSE_COMBINED.CLICK","{handler:'E12162',iparms:[]");
         ...
         setEventMetadata("FILTERTOGGLE_ONLYDETAILED.CLICK","{handler:'E13162',iparms:[{av:'divFiltercollapsiblesection_onlydetailed_Visible',ctrl:'FILTERCOLLAPSIBLESECTION_ONLYDETAILED',prop:'Visible'}]");
         ...
         setEventMetadata("FILTERCLOSE_ONLYDETAILED.CLICK","{handler:'E14162',iparms:[]");
         ...
         setEventMetadata("DOWNLOADSACTIONTOGGLE.CLICK","{handler:'E17161',iparms:[{av:'divDownloadactionstable_Visible',ctrl:'DOWNLOADACTIONSTABLE',prop:'Visible'}]");
